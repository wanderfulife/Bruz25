...
const pageTitle = ref('Bruz25'); // Browser tab title
...
const customWelcomeMessage = ref(`
  Bonjour, Rennes Métropole et La Ville de Bruz<br><br> souhaitent mieux connaître les habitudes de stationnement en centre ville.<br><br>  Auriez-vous 2 minutes à nous accorder pour répondre à quelques questions ?
